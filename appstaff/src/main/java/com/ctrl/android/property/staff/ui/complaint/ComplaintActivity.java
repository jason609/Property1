...
public class ComplaintActivity extends AppToolBarActivity implements View.OnClickListener{
   ...
   // private MyBroadCastReceiver mbc;
    ...
    private void init() {
        ...
        ComplaintFragment fragment01 = ComplaintFragment.newInstance(StrConstant.REPAIRS_PENDING);
        ComplaintFragment fragment02 = ComplaintFragment.newInstance(StrConstant.REPAIRS_PROGRESSING);
        ComplaintFragment fragment03 = ComplaintFragment.newInstance(StrConstant.REPAIRS_PROGRESSED);
        ComplaintFragment fragment04 = ComplaintFragment.newInstance(StrConstant.REPAIRS_END);
       ...
       // fragmets.put(4, fragment05);
        ...
        viewPagerAdapter.setOnReloadListener(new JasonViewPagerAdapter.OnReloadListener() {
            ...
            public void onReload() {
                ...
                list.add( ComplaintFragment.newInstance(StrConstant.REPAIRS_PENDING));
                list.add( ComplaintFragment.newInstance(StrConstant.REPAIRS_PROGRESSING));
                list.add(ComplaintFragment.newInstance(StrConstant.REPAIRS_PROGRESSED));
                list.add(ComplaintFragment.newInstance(StrConstant.REPAIRS_END));
