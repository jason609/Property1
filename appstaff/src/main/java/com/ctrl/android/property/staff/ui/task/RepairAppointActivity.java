...
public class RepairAppointActivity extends AppToolBarActivity implements View.OnClickListener{
    ...
    private void init() {
        ...
        RepairAppointFragment fragment01 = RepairAppointFragment.newInstance("0");
        RepairAppointFragment fragment04 = RepairAppointFragment.newInstance("1");
        ...
        viewPagerAdapter.setOnReloadListener(new JasonViewPagerAdapter.OnReloadListener() {
            ...
            public void onReload() {
                ...
                list.add(RepairAppointFragment.newInstance("0"));
                list.add(RepairAppointFragment.newInstance("0"));
